...
// Ausgabe Ergebnis in Decimal
	...
	public static String vonDec(int eingabe, int ZahlensytemAusgabe) throws EigeneCheckedException { // von Decimal in jedes andere System
...
// Zusammensetzen der Einzellen Werte
	...
	/*
	 * public double pot(double basis, double potenzwert) { if(potenzwert == 0) {
	 * return 1.0; } if(basis == 0) { return 0; } return null;
	 * 
	 * }
	 */
